...
class Test_HBNBCommand_prompt(unittest.TestCase):
    """Unittests for testing the prompting of the HBNB command interpreter"""
...
class Test_HBNBCommand_help(unittest.TestCase):
    """Unittests for testing the help messages of HBNB command interpreter"""
...
class Test_HBNBCommand_exit(unittest.TestCase):
    """Unittests for testing the exiting from the HBNB command interpreter"""
...
class Test_HBNBCommand_show(unittest.TestCase):
    ...
    def test_show_missing_id_d_notation(self):
        correct = "** instance id missing **"
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_show_no_instance_found_d_notation(self):
        correct = "** no instance found **"
        with patch("sys.stdout", new=StringIO()) as output:
...
class Test_HBNBCommand_destroy(unittest.TestCase):
    ...
    def test_destroy_id_missing_d_notation(self):
        correct = "** instance id missing **"
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_destroy_invalid_id_d_notation(self):
        correct = "** no instance found **"
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_destroy_objects_d_notation(self):
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create BaseModel"))
            testID = output.getvalue().strip()
        with patch("sys.stdout", new=StringIO()) as output:
...
class Test_HBNBCommand_all(unittest.TestCase):
    ...
    def test_all_objects_d_notation(self):
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create BaseModel"))
            self.assertFalse(HBNBCommand().onecmd("create User"))
            self.assertFalse(HBNBCommand().onecmd("create State"))
    ...
    def test_all_single_object_d_notation(self):
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create BaseModel"))
            self.assertFalse(HBNBCommand().onecmd("create User"))
            self.assertFalse(HBNBCommand().onecmd("create State"))
...
class Test_HBNBCommand_update(unittest.TestCase):
    ...
    def test_update_missing_id_d_notation(self):
        correct = "** instance id missing **"
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_update_invalid_id_d_notation(self):
        correct = "** no instance found **"
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_update_missing_attri_name_space_notation(self):
    ...
    def test_update_missing_attri_name_d_notation(self):
        correct = "** attribute name missing **"
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create BaseModel"))
            testId = output.getvalue().strip()
    ...
    def test_update_missing_attri_value_space_notation(self):
    ...
    def test_update_missing_attri_value_d_notation(self):
        correct = "** value missing **"
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create BaseModel")
            testId = output.getvalue().strip()
    ...
    def test_update_valid_string_attri_space_notation(self):
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create BaseModel")
            testId = output.getvalue().strip()
    ...
    def test_update_valid_string_attri_d_notation(self):
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create BaseModel")
    ...
    def test_update_valid_int_attri_space_notation(self):
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create Place")
            testId = output.getvalue().strip()
    ...
    def test_update_valid_int_attri_d_notation(self):
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create Place")
            tId = output.getvalue().strip()
    ...
    def test_update_valid_float_attri_d_notation(self):
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create Place")
            tId = output.getvalue().strip()
    ...
    def test_update_valid_dictionary_d_notation(self):
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create BaseModel")
            testId = output.getvalue().strip()
        testCmd = "BaseModel.update({}".format(testId)
    ...
    def test_update_valid_dictionary_int_space_notation(self):
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create Place")
            testId = output.getvalue().strip()
        testCmd = "update Place {} ".format(testId)
    ...
    def test_update_valid_dictionary_int_d_notation(self):
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create Place")
            testId = output.getvalue().strip()
        testCmd = "Place.update({}, ".format(testId)
    ...
    def test_update_valid_dictionary_float_space_notation(self):
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create Place")
            testId = output.getvalue().strip()
        testCmd = "update Place {} ".format(testId)
    ...
    def test_update_valid_dictionary_float_d_notation(self):
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create Place")
            testId = output.getvalue().strip()
        testCmd = "Place.update({}, ".format(testId)
